...
generateSets.generateSets = function (dataset, determineRunProperties, paramObject, paramIndexArray, tolerance, numberOfProfile, numberOfPoints, indexInc, indexMult, s) {
  let Maxloglik
