...
snippet.toEst = function(params) {
  params[paramObject.Mu] = Math.log(params[paramObject.Mu])
  params[paramObject.SIGMA] = Math.log(params[paramObject.SIGMA])
  params[paramObject.PSI] = Math.log(params[paramObject.PSI])
  params[paramObject.GAMMA] = Math.log(params[paramObject.GAMMA])
  params[paramObject.R0Index] = Math.log(params[paramObject.R0Index])
  params[paramObject.RHO] = mathLib.logit(params[paramObject.RHO])
  params[paramObject.AMPLITUDE]= mathLib.logit(params[paramObject.AMPLITUDE])
}

snippet.fromEst = function (params) {
  params[paramObject.Mu] = Math.exp(params[paramObject.Mu])
  params[paramObject.SIGMA] = Math.exp(params[paramObject.SIGMA])
  params[paramObject.PSI] = Math.exp(params[paramObject.PSI])
  params[paramObject.GAMMA] = Math.exp(params[paramObject.GAMMA])
  params[paramObject.R0Index] = Math.exp(params[paramObject.R0Index])
  params[paramObject.RHO] = mathLib.expit(params[paramObject.RHO])
  params[paramObject.AMPLITUDE]= mathLib.expit(params[paramObject.AMPLITUDE]) 
}
